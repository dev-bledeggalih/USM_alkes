...
Route::group(['middleware'=>['frontlogin']],function(){
	...
	Route::post('/wishlist/add-wishlist','ProductsController@addWishlist');
	Route::get('/wishlist/delete-wishlist/{id}','ProductsController@deleteWishlistProduct');
	Route::post('/wishlist/storeToCart','ProductsController@storeWishlistToCart');
...
Route::group(['middleware' => ['adminlogin']], function () {
	...
	Route::match(['get', 'post'], '/admin/delete-brand/{id}','BrandsController@deleteBrand');
	Route::get('/admin/view-brand','BrandsController@viewBrand');
	...
	Route::get('/admin/orderDetailsToPdf/{id}','ProductsController@orderDetailsToPdf');
