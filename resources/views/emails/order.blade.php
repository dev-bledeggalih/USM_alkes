	...
	<table width='700px'>
		...
		<tr><td>
			<table width='95%' cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
				...
				@endforeach
				<tr>
					<td colspan="5" align="right">Shipping Charges</td><td>IDR {{ $productDetails['shipping_charges'] }}</td>
				</tr>
				<tr>
					<td colspan="5" align="right">Coupon Discount</td><td>IDR {{ $productDetails['coupon_amount'] }}</td>
				</tr>
				<tr>
					<td colspan="5" align="right">Grand Total</td><td>IDR {{ $productDetails['grand_total'] }}</td>
				</tr>
			</table>
		</td></tr>
		<tr><td>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td>For any enquiries, you can contact us at <a href="mailto:no-reply@bledeggalih.com">no-reply@bledeggalih.com</a></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>Regards,<br> PT. Uhuy Indonesia</td></tr>
		<tr><td>&nbsp;</td></tr>
	</table>
</body>
</html>