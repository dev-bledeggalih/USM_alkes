				...
				<div class="total_area">
					<ul>
						@if(!empty(Session::get('CouponAmount')))
							<li>Sub Total <span>IDR <?php echo $total_amount; ?></span></li>
							<li>Coupon Discount <span>IDR <?php echo Session::get('CouponAmount'); ?></span></li>
							<?php 
							...
							<li>Grand Total <span class="btn-secondary" data-toggle="tooltip" data-html="true" title="
								...
								">IDR <?php echo $total_amount; ?></span></li>
						@else
