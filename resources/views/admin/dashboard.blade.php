      ...
      <div class="widget-box">
        ...
        <div class="widget-content" >
          <div class="row-fluid">
            ...
            <div class="span3">
              <ul class="site-stats">
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{ $countUser }}</strong> <small>Total Users</small></li>
                <li class="bg_lh"><i class="icon-plus"></i> <strong>{{ $getUserToday }}</strong> <small>New Users </small></li>
                <li class="bg_lh"><i class="icon-repeat"></i> <strong>{{ $pendingOrder }}</strong> <small>Pending Orders</small></li>
                <li class="bg_lh"><i class="icon-tag"></i> <strong>{{ $totalOrder }}</strong> <small>Total Orders</small></li>
                <li class="bg_lh"><i class="icon-shopping-cart"></i> <strong>{{ $offlineOrder }}</strong> <small>Offline Orders</small></li>
                <li class="bg_lh"><i class="icon-globe"></i> <strong>{{ $onlineOrder }}</strong> <small>Online Orders</small></li>
              </ul>
            </div>
          </div>
        </div>
