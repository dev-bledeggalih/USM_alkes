        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-banner/'.$bannerDetails->id) }}" name="edit_banner" id="edit_banner" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                <label class="control-label">Grid Banner</label>
                <div class="controls">
                  <input type="radio" name="subBanner" value="0">Main Grid Slideshow<br>
                  <input type="radio" name="subBanner" value="1">Grid 1<br>
                  <input type="radio" name="subBanner" value="2">Grid 2<br>
                  <input type="radio" name="subBanner" value="3">Grid 3<br>
                  <input type="radio" name="subBanner" value="4">Grid 4<br>
                  <input type="radio" name="subBanner" value="5">Main Grid Product Slideshow
                </div>
              </div>
