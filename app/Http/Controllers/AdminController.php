...
class AdminController extends Controller
{
    ...
    public function dashboard(){
        ...
        $pendingOrder = Order::where('order_status','=','New')->orWhere('order_status','=','Pending')->count();
        $offlineOrder = Order::where('payment_method','=','COD')->count();
        $onlineOrder = Order::where('payment_method','=','Paypal')->count();
        $totalOrder = Order::count();

        return view('admin.dashboard')->with(compact('countUser','getUserToday','pendingOrder','offlineOrder','onlineOrder','totalOrder'));
    }
