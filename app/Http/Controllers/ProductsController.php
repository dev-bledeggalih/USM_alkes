...
class ProductsController extends Controller
{
	public function addProduct(Request $request){
        ...
        foreach($brands as $bra){
            $brands_drop_down .= "<option value='".$bra->id."'>".$bra->name."</option>";
        }
		...
		return view('admin.products.add_product')->with(compact('categories_drop_down','brands_drop_down','sleeveArray','patternArray'));
	}  
	...
	public function editProduct(Request $request,$id=null){
		...
		return view('admin.products.edit_product')->with(compact('productDetails','categories_drop_down','brands_drop_down','sleeveArray','patternArray'));
	} 
    ...
    public function addAttributes(Request $request, $id=null){
        ...
        return view('admin.products.add_attributes')->with(compact('title','productDetails','category_name','brand_name'));
    }
    ...
    public function products($url=null){
    	...
    	return view('products.listing')->with(compact('categories','productsAll','categoryDetails','banners','meta_title','meta_description','meta_keywords','url','colorArray','sleeveArray','patternArray','sizesArray','breadcrumb'));
    }
    ...
    public function searchProducts(Request $request){
        if($request->isMethod('post')){
            ...
            return view('products.listing')->with(compact('categories','productsAll','banners','search_product','breadcrumb')); 
        }
    }
    ...
    public function orderDetailsToPdf($order_id){
        $orderDetails = Order::with('orders')->where('id',$order_id)->first();
        $orderDetails = json_decode(json_encode($orderDetails));
        /*echo "<pre>"; print_r($orderDetails); die;*/
        $user_id = $orderDetails->user_id;
        ...
        return $pdf->stream('orderList.pdf');
    }
    ...
    public function viewWishlist(){
        if(Auth::check()){
            ...
            $session_id = Session::get('session_id');
            $userWishlist = DB::table('wishlist')->where(['session_id' => $session_id])->get();    
        }
        ...
        /*echo "<pre>"; print_r($userCart); die;*/
        $meta_title = "Schon - User Wishlist";
        $meta_description = "View Wishlist of Schon";
        $meta_keywords = "view wishlist, Schon";
        return view('wishlist/view_wishlist')->with(compact('userWishlist','meta_title','meta_description','meta_keywords'));
    }
    ...
    public function addWishlist(Request $request){
        ...
        if(empty(Auth::check())){
            $countProducts = DB::table('wishlist')->where(['product_id' => $data['product_id'],'session_id' => $session_id])->count();
            if($countProducts>0){
                return redirect()->back()->with('flash_message_error','Product already exist in Cart!');
            }
        }else{
        ...
        DB::table('wishlist')
        ->insert(['product_id' => $data['product_id'],'product_name' => $data['product_name'],'product_price' => $data['product_price'],'user_email' => $data['user_email'],'session_id' => $session_id]);
        // dd($data);

        return redirect('products/detail/'.$product_id)->with('flash_message_success','Product has been added in Whislist!');
    }


    public function storeWishlistToCart(Request $request){
        $data = $request->all();
    ...
    public function deleteWishlistProduct($id=null){
        ...
        return redirect('wishlist/view_wishlist')->with('flash_message_success','Product has been deleted in Wishlist!');
    }
